...
import { Award, Loader2, Download, Share2, GraduationCap } from "lucide-react";
...
export default function CertificatesPage() {
  ...
  async function downloadCertificate(cert: Certificate) {
    try {
      ...
      // Use server-side PDF generation for better quality
      ...
      link.href = url;
      link.download = `ROA-Certificate-${cert.certificateNumber}.pdf`;
